...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(92, 348);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(396, 348);
			...
			this->radioButton1->Location = System::Drawing::Point(79, 94);
			...
			this->radioButton2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(204)));
			this->radioButton2->Location = System::Drawing::Point(79, 167);
			...
			this->radioButton3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 14.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(204)));
			this->radioButton3->Location = System::Drawing::Point(79, 249);
			...
			this->ClientSize = System::Drawing::Size(704, 383);
...
int SavollarSoni; // Счет вопросов
int TogriJavob; // Количество правильных ответов
int NoTogriJavob; // Количество не правильных ответов
// Массив вопросов, на которые даны неправильные ответы:
array<String^>^ NoTogri_javoblar;
int TogriJavobNomeri; // Номер правильного ответа
int Tanlangan_javob; // Номер ответа, выбранный студентом
...
gcnew EventHandler(this, &Form2::Keyingi_savolga_otish);
...
+ "\\test.txt", Кодировка);
this->Text = oqish->ReadLine(); // Название предмета
...
TogriJavob = TogriJavob + 1;
if (Tanlangan_javob != TogriJavobNomeri)
{ // Счет неправильных ответов:
NoTogriJavob = NoTogriJavob + 1;
// Запоминаем вопросы с неправильными ответами:
NoTogri_javoblar[NoTogriJavob] = label1->Text;
}
...
"5 balli tizimda baholash: {2:F2}.", TogriJavob,
SavollarSoni, (TogriJavob * 5.0F) / SavollarSoni);
// 5F - это максимальная оценка
button1->Text = "Testni boshidan boshlash";
